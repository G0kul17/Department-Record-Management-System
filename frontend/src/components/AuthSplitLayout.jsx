  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-[#f8fafc] to-[#f1f5f9] px-3 py-4 sm:px-6 sm:py-4 flex items-center justify-center">
      ...
      <div className="auth-card-rise relative mx-auto flex h-fit w-full max-w-6xl flex-col overflow-hidden rounded-[2rem] border border-white/30 bg-white/95 shadow-[0_35px_90px_rgba(2,6,23,0.68)] backdrop-blur-sm md:flex-row">
        <section
          className="relative flex w-full min-h-[220px] items-end overflow-hidden p-5 sm:p-8 md:min-h-full md:w-[48%] md:p-8"
          style={panelStyle}
        >
          <div
          ...
          <div className="relative z-10 max-w-xs text-white">
            <p className="mb-3 text-[10px] tracking-[0.25em] text-white/80 [font-family:'DM_Sans',sans-serif] sm:mb-5 sm:text-xs sm:tracking-[0.3em]">
              {heroEyebrow}
            </p>
            <h2 className="text-4xl leading-[0.9] text-white [font-family:'Cormorant_Garamond',serif] sm:text-5xl md:text-6xl">
              {heroTitle}
            </h2>
            <p className="mt-3 text-xs leading-relaxed text-white/85 [font-family:'DM_Sans',sans-serif] sm:mt-4 sm:text-sm">
              {heroDescription}
            </p>
          </div>
        </section>
