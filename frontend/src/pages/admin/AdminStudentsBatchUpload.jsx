...
import { FaUserGraduate, FaArrowLeft, FaFileDownload, FaCloudUploadAlt, FaEye } from "react-icons/fa";
    ...
    <div className="min-h-[calc(100vh-4rem)] bg-[#f8fafc] w-full">
      <div className="w-full px-4 sm:px-6 lg:px-10 py-4 sm:py-6 space-y-4">
        ...
        <div className="flex items-center gap-3.5 bg-white rounded-2xl p-4 sm:p-5 border border-slate-200/90 shadow-sm w-full">
          <span className="flex h-12 w-12 items-center justify-center rounded-xl bg-fuchsia-100 text-fuchsia-600 shadow-xs flex-shrink-0">
        ...
        <div className="bg-white rounded-2xl border border-slate-200/90 p-5 shadow-sm space-y-5 w-full">
          ...
          <div className="rounded-xl bg-slate-50 border border-slate-200/80 p-4 space-y-2 text-xs">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-5 gap-2 text-slate-600 font-medium">
              ...
              <span className="bg-white border rounded-lg px-2.5 py-1 text-[11px] font-bold">Register number</span>
              <span className="bg-white border rounded-lg px-2.5 py-1 text-[11px] font-bold">Contact number</span>
              <span className="bg-white border rounded-lg px-2.5 py-1 text-[11px] font-bold">Year</span>
              <span className="bg-white border rounded-lg px-2.5 py-1 text-[11px] font-bold">Dept</span>
              <span className="bg-white border rounded-lg px-2.5 py-1 text-[11px] font-bold">Course</span>
              <span className="bg-white border rounded-lg px-2.5 py-1 text-[11px] font-bold">Section</span>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 pt-2">
            <a
              ...
              className="inline-flex items-center gap-1.5 text-xs font-extrabold text-fuchsia-600 hover:underline"
            >
            ...
            <div className="flex items-center gap-2.5">
              <button
                ...
                className="inline-flex items-center gap-1.5 rounded-xl border border-fuchsia-300 bg-fuchsia-50 px-4 py-2 text-xs font-extrabold text-fuchsia-700 hover:bg-fuchsia-100 transition cursor-pointer disabled:opacity-50"
              >
              ...
              <button
                ...
                className="inline-flex items-center gap-2 rounded-xl bg-fuchsia-600 hover:bg-fuchsia-700 px-6 py-2 text-xs font-extrabold text-white shadow-md shadow-fuchsia-500/20 transition disabled:opacity-50 cursor-pointer"
              >
                <FaCloudUploadAlt className="w-3.5 h-3.5" />
                {submitting ? "Uploading..." : "Upload Students Batch"}
              </button>
            </div>
          </div>
          ...
          {validationErrors.length > 0 && (
            <div className="rounded-xl border border-rose-200 bg-rose-50 p-4 text-xs text-rose-800 space-y-1">
              <div className="font-extrabold text-rose-900">Row Validation Details</div>
