        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 w-full">
          ...
          <div className="lg:col-span-6 bg-white rounded-2xl border border-slate-200/90 p-5 shadow-sm space-y-4">
            <h2 className="text-sm font-extrabold text-slate-900 flex items-center gap-2 pb-2 border-b border-slate-100">
              <FaPlus className="text-amber-500 w-3.5 h-3.5" />
            ...
            <form onSubmit={handleAdd} className="space-y-3 pt-2">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-slate-300 px-3.5 py-2.5 text-xs font-semibold text-slate-900 focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-600 shadow-xs"
                  required
                />
              </div>
              ...
              <div className="flex justify-end pt-2">
                <button
                  type="submit"
                  disabled={saving}
                  className="inline-flex items-center gap-2 rounded-xl bg-amber-600 hover:bg-amber-700 px-6 py-2.5 text-xs font-extrabold text-white shadow-md shadow-amber-500/20 transition disabled:opacity-50 cursor-pointer"
                >
          ...
          <div className="lg:col-span-6 bg-white rounded-2xl border border-slate-200/90 p-5 shadow-sm space-y-4">
            <div className="flex items-center justify-between pb-2 border-b border-slate-100">
              ...
              <button
                ...
                onClick={refresh}
                disabled={loading}
                className="inline-flex items-center gap-1.5 rounded-xl border border-amber-200 bg-amber-50 px-3 py-1.5 text-xs font-extrabold text-amber-700 hover:bg-amber-100 transition cursor-pointer"
              >
